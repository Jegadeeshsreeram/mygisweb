...
map.getView().fit([8546896.177531, 1111696.991500, 8625235.278878, 1155571.342503], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Devikulam_administrative_boundary</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (96 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Devikulam is a hillstation located at idukki distriict is one of the beautiful places in kerala.';
            }
